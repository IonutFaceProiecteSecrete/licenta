...
import ReviewPrestator from "./ReviewPrestator";
        ...
        <Grid item lg={8} sm={sub800px ? 12 : 8} xs={12} padding={2}>
          <Stack alignItems="center">
            <Grid container lg={12} sm={12} xs={12} spacing={2}>
              ...
              >
                <Typography color={theme.palette.logo.main} mr={1}>5</Typography>
            ...
            <Grid container lg={12} sm={12} xs={12} spacing={2}>
              <Grid
                ...
                justifyContent="center"
              >
                <Typography color={theme.palette.logo.main} mr={1}>4</Typography>
                <StarIcon sx={{ color: theme.palette.primary.main }} />
              </Grid>
              <Grid item lg sm xs>
                <LinearProgress
            ...
            <Grid container lg={12} sm={12} xs={12} spacing={2}>
              <Grid
                ...
                justifyContent="center"
              >
                <Typography color={theme.palette.logo.main} mr={1}>3</Typography>
                <StarIcon sx={{ color: theme.palette.primary.main }} />
              </Grid>
              <Grid item lg sm xs>
                <LinearProgress
            ...
            <Grid container lg={12} sm={12} xs={12} spacing={2}>
              <Grid
                ...
                justifyContent="center"
              >
                <Typography color={theme.palette.logo.main} mr={1}>2</Typography>
                <StarIcon sx={{ color: theme.palette.primary.main }} />
              </Grid>
              <Grid item lg sm xs>
                <LinearProgress
            ...
            <Grid container lg={12} sm={12} xs={12} spacing={2}>
              <Grid
                ...
                justifyContent="center"
              >
                <Typography color={theme.palette.logo.main} mr={1}>1</Typography>
                <StarIcon sx={{ color: theme.palette.primary.main }} />
              </Grid>
              <Grid item lg sm xs>
                <LinearProgress
